...
const projects = [
    {
        ...
        image: "https://images.unsplash.com/photo-1586773860418-d3b97998c63d?q=80&w=2000&auto=format&fit=crop"
    },
    {
    ...
    },
    {
        ...
        image: "https://images.unsplash.com/photo-1534081333815-ae5019106622?q=80&w=2000&auto=format&fit=crop"
    },
    {
            ...
            <div className="container py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {projects.map((project, i) => (
                        <Card key={i} className="overflow-hidden border-none shadow-none bg-transparent group">
